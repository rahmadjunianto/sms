...
<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"  action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="nm_alok_b" placeholder="Nama Alokasi Biaya" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $nm_alok_b; ?>">
<input type="hidden" name="kd_alok_b" value="<?php echo $kd_alok_b; ?>" />                           
                        </div>
                      </div>
