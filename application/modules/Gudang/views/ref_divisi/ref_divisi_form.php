...
<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"  action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="nm_divisi" placeholder="Nama Divisi" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $nm_divisi; ?>">
<input type="hidden" name="kd_divisi" value="<?php echo $kd_divisi; ?>" />                           
                        </div>
                      </div>
