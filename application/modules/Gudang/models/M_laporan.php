...
class M_laporan extends CI_Model
{
    ...
    function json_lap_per_divisi() {
        ...
        $this->datatables->select('a.kd_barang,a.nm_barang, satuan,c.nm_kategori, IFNULL(b.jumlah, 0) jumlah');
        $this->datatables->from('ref_barang a');
        $this->datatables->join("(SELECT kd_barang,nm_barang,SUM(jumlah) jumlah FROM tr_barang_keluar WHERE kd_unit=$unit AND tanggal BETWEEN '$date1' AND '$date2' GROUP BY kd_barang,nm_barang) b", "a.kd_barang=b.kd_barang","left");
