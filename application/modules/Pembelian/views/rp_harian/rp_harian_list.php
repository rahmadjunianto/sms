<?php echo $this->session->flashdata('message')?><br>
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title"> 
                    <h2>Rekap Pembayaran Harian</h2>                   
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
        <form  data-parsley-validate action=""<?php echo base_url().'pembelian/man_bap'?>" method="post">
            ...
            $(document).ready(function() {
              var base="<?php echo base_url()?>";
                ...
                var t = $("#example2").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?php echo base_url()?>Pembelian/rp_harian/json", "type": "POST"},
                    columns: [
                        {
                            "data": "kode_supplier",
                            "orderable": false,
