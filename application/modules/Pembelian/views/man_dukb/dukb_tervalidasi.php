<?php echo $this->session->flashdata('message')?><br>
 ...
 <br>                   <?php if($rk=="tampil"){?>
                    <table id="example2" class=" table table-striped table-bordered" style="font-size: 12px">
                      <thead>
                        <tr>
                          ...
                          <th class="text-center" width="8%">Tanggal DUKB</th>
                          <th class="text-center" width="8%">Tanggal Validasi</th>
       ...
       <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#example2").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?php echo base_url()?>Pembelian/man_dukb/json_terval", "type": "POST"},
                    columns: [
                        {
                            "data": "id_dukb",
                            "orderable": false,
                            "className" : "text-center",
                        },{"data": "tanggal"},{"data": "tanggal_val"},{"data": "kd_siklus"},{"data":"nama_supplier"},{"data": "kabupaten"},{"data": "kecamatan"},{"data": "status"},
         {
    ...
    "render": function ( data, type, row, meta ) {
               ...
               case 'Belum Tervalidasi' : return "<div class='btn-group'><a href='<?php echo base_url()?>/pembelian/man_dukb/detail/"+row['id_dukb']+".html' class='btn btn-xs btn-success'><i class='fa fa-binoculars'></i></a></div><div class='btn-group' ><a href='<?php echo base_url()?>/pembelian/man_dukb/validasi_action/"+row['id_dukb']+".html' class='btn btn-xs btn-primary' onclick='return deleteConfirmation()' ><i class='fa fa-check'></i></a></div>"; break;
               default  : return 'N/A';
            }
    }
  }
