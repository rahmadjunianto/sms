...
class Mlap_wil extends CI_Model
{
    ...
    function json() {
        ...
        $this->datatables->add_column('action', '<div class="btn-group">'.anchor(site_url('pembelian/lap_wil/detail/$1'),'<i class="fa fa-binoculars"></i>','class="btn btn-xs btn-success"').'</div>', 'id_dukb');
