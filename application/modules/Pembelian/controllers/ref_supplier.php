...
class ref_supplier extends CI_Controller {
	...
	{
		$this->template->load('welcome/halaman','Pembelian/ref_supplier/Ref_supplier_list');
	}
    ...
    public function create() 
    {
        $data = array(
            ...
            'action'     => site_url('Pembelian/ref_supplier/create_action'),
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                ...
                'action'     => site_url('pembelian/ref_supplier/update_action'),
