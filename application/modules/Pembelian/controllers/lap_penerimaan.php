...
class lap_penerimaan extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data['rk'] =$this->Mlap_penerimaan->getlist($kabupaten,$kecamatan,$date1,$date2);   
        $this->load->view('Pembelian/lap_penerimaan/list_excel',$data);
    }
...
JOIN ref_grader c ON a.kd_grader=c.kd_grader WHERE id_dukb=$id")->row();
        ...
        $sumber = $this->load->view('lap_penerimaan/lap_penerimaan_pdf',$data,true);
        $html = $sumber;
